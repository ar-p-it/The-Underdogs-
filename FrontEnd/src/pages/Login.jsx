...
export default function Login() {
  ...
  const submit = async (e) => {
    ...
    setError("");
    try {
      await api("/login", { method: "POST", body: { emailId, password } });
      navigate("/dashboard");
    } catch (err) {
          ...
          <div className="card-body">
            ...
            <form className="flex flex-col gap-4" onSubmit={submit}>
              ...
              <div className="card-actions justify-between items-center pt-4">
                <Link to="/signup" className="link link-hover text-sm text-gray-600">
                  New here? Create an account.
                </Link>
                <button className="btn px-8 text-white bg-emerald-500 border-none" type="submit" disabled={loading}>
